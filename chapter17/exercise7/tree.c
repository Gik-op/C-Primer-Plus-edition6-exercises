...
bool AddItem(const Item * pi, Tree * ptree)
{
    ...
    if (SeekItem(pi, ptree).child != NULL)/* find the same item, times++ */
    {
        SeekItem(pi,ptree).child->times++;
    }
...
static void AddNode (Trnode * new_node, Trnode * root)/* duplicates have been ruled out */
{
